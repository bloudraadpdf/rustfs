...
pub mod storage {
    ...
    pub use crate::store::{
        ClosedPrefixProofV1, ClosedPrefixV1, ECStore, SCANNER_PUBLICATION_LEASE_TTL_MS, ScannerDataMovementPauseStatus,
        all_local_disk, all_local_disk_path, find_local_disk_by_ref, init_local_disks, init_local_disks_with_instance_ctx,
        init_lock_clients, prewarm_local_disk_id_map, prewarm_local_disk_id_map_with_instance_ctx,
    };
}
